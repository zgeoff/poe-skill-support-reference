...
export const testGemData: GemData = {
  ...
  blue: {
    "Arc": [
      "Added Lightning Damage Support", "Spell Echo Support", "Faster Casting Support",
      "Inspiration Support", "Controlled Destruction Support", "Lightning Penetration Support",
    ],
    "Ball Lightning": ["Spell Echo Support", "Slower Projectiles Support", "Controlled Destruction Support"],
